...
OutsideFatherDetailsModel parentDetailsModelFromJson(String str) => OutsideFatherDetailsModel.fromJson(json.decode(str));

String parentDetailsModelToJson(OutsideFatherDetailsModel data) => json.encode(data.toJson());


class OutsideFatherDetailsModel {
  String? statusCode;
  Body? body;

  OutsideFatherDetailsModel({this.statusCode, this.body});

  factory OutsideFatherDetailsModel.fromJson(Map<String, dynamic> json) {
    return OutsideFatherDetailsModel(
...
class Body {
  ...
  String? petVariety;
  String? updatedAt;
  String pkOutsideFatherId;
  String? shopId;
  String? managementNumber;
  Images? images;
  RetireInformation? retireInformation;
  String? outsideFatherDeleteFlag;
  ...
  Body({
    ...
    this.petVariety,
    this.updatedAt,
    required this.pkOutsideFatherId,
    this.outsideFatherDeleteFlag,
    this.shopId,
  ...
  factory Body.fromJson(Map<String, dynamic> json) {
    return Body(
      ...
      pkOutsideFatherId: json['pk_outside_father_id'],
      outsideFatherDeleteFlag: json['outside_father_delete_flag'],
      shopId: json['shop_id'],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['pk_outside_father_id'] = this.pkOutsideFatherId;
    data['outside_father_delete_flag'] = this.outsideFatherDeleteFlag;
